	...
	for _, eventsURI := range auditConfig.AuditEventsURI {
		...
		case dynamo.GetName():
			...
			cfg := dynamoevents.Config{
				...
				ReadMinCapacity:         int(auditConfig.ReadMinCapacity),
				ReadMaxCapacity:         int(auditConfig.ReadMaxCapacity),
				ReadTargetValue:         auditConfig.ReadTargetValue,
				WriteMinCapacity:        int(auditConfig.WriteMinCapacity),
				WriteMaxCapacity:        int(auditConfig.WriteMaxCapacity),
